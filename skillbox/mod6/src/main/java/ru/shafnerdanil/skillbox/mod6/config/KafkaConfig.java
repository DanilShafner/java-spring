package ru.shafnerdanil.skillbox.mod6.config;
...
import ru.shafnerdanil.skillbox.mod6.dto.OrderEvent;
import ru.shafnerdanil.skillbox.mod6.dto.OrderStatusEvent;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "ru.shafnerdanil.skillbox.mod6");
